    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-xl font-bold text-kmss-berry mb-2">왜 '엄마학자'이어야 하는가?</h2>
